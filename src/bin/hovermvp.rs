...
fn handle_laser(
    ...
    for pilot in qpilot.iter() {
        ...
        if pilot.fire_large_laser {
            ...
            let (laser_vertices, laser_indices) = laser::get_laser_vertices(real_laser_origin, real_laser_dest);
            actual_mesh.insert_attribute(Mesh::ATTRIBUTE_POSITION, laser_vertices);
